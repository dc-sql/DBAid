...
CREATE TABLE [checkmk].[config_perfcounter]
(
...
CREATE UNIQUE CLUSTERED INDEX [UQ_config_perfcounter] ON [checkmk].[config_perfcounter] ([object_name], [counter_name], [instance_name])
